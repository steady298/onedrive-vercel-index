...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'steady998@qyr7.onmicrosoft.com',
  ...
  protectedRoutes: ['/Public/video', '/🥟 Some test files/Protected route'],
